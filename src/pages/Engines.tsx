...
const Engines = () => {
  const engines = [
    ...
    },
    {
      ...
      description: "Универсальный двигатель для повседневных полетов с отличным балансом мощности и экономичности",
      weight: "Уточняется по паспорту партии",
      thrust: "Уточняется по паспорту партии",
      propeller: "Уточняется по паспорту партии",
      features: [
        "Низкий уровень вибраций",
        "Увеличенный моторесурс",
